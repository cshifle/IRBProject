...
$permissionMatch = mysqli_query($db, $query);
...
$query = "INSERT INTO expeditedApp (user, date, title, sponsor, sponsorEmail, department, extension, student, studentEmail, studentPhone, abstract, status, facultyStatus, memberStatus, memberAssigned) VALUES ('$user', CURRENT_TIMESTAMP, '$title', '$sponsor', '$sponsorEmail', '$department', '$phone', '$student', '$studentemail', '$studentphone', '$abstract', '$status', '$facultyStatus', '$memberStatus', '$memberAssigned')";
